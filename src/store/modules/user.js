import Vue from 'vue'
import { login ,queryPermissionsByUser,logout} from "@/services/user"
import { ACCESS_TOKEN, USER_NAME,USER_INFO,UI_CACHE_DB_DICT_DATA,USER_AUTH,SYS_BUTTON_AUTH,TENANT_ID,CACHE_INCLUDED_ROUTES  } from "@/store/mutation-types"
